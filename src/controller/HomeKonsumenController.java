...
public class HomeKonsumenController implements Initializable {
    ...
    private void handleButtonKeluar(ActionEvent event) throws IOException {
        ...
        loader.setLocation(HomeKonsumenController.class.getResource("/view/LandingPage.fxml"));
    ...
    @FXML
    private void handleButtonMemesanAction(ActionEvent event)  throws Exception{
        System.out.println("tes");
        FXMLLoader loader = new FXMLLoader(); 
        loader.setLocation(HomeProdusenController.class.getResource("/view/Memesan.fxml"));
        Stage dialogStage = new Stage(); 
        dialogStage.setTitle("testing");
        dialogStage.initModality(Modality.APPLICATION_MODAL); 
        Scene scene = new Scene(loader.load()); 
    ...
    private void handleButtonInboxAction(ActionEvent event)  throws Exception{
        System.out.println("tes");
        FXMLLoader loader = new FXMLLoader(); 
        loader.setLocation(HomeProdusenController.class.getResource("/view/InboxKonsumen.fxml"));
        Stage dialogStage = new Stage(); 
        dialogStage.setTitle("testing");
        dialogStage.initModality(Modality.APPLICATION_MODAL); 
        Scene scene = new Scene(loader.load()); 
    ...
    private void handleButtonRiwayatAction(ActionEvent event)  throws Exception{
        System.out.println("tes");
        FXMLLoader loader = new FXMLLoader(); 
        loader.setLocation(HomeProdusenController.class.getResource("/view/RiwayatKonsumen.fxml"));
        Stage dialogStage = new Stage(); 
        dialogStage.setTitle("testing");
        dialogStage.initModality(Modality.APPLICATION_MODAL); 
        Scene scene = new Scene(loader.load()); 
